...
# convert to string form, like: '1.2.3'
...
def repl(
    ...
    model_path: Annotated[
        str,
        typer.Option("--path", "-p", help="Local model path"),
    ] = None,
    n_threads: Annotated[
        int,
    ...
    if model_path == "andeya-local":
        model_path = MODEL_ROOT

    gpt4all_instance = GPT4All(model_name=model, model_path=model_path, device=device)
